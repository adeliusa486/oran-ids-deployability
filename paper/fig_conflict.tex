...
\node[anchor=west, align=left] at (-0.05,4.42) {\textbf{file \LcBenignFile}\\station 1};
\fcRecord{4.42}{20}{45}
...
\node[anchor=west, align=left] at (-0.05,3.34) {\textbf{file \LcAttackFile}\\station 2};
\fcRecord{3.34}{70}{90}
...
\node[anchor=west, align=left] at (2.16,1.50)
     {every record unique: ceiling \LcCeilPos{}; four reproduced\\classifiers reach \PubRzAccMin--\PubRzAccMax\% accuracy; DT, RF\\and MLP fall to \PubOneNoposAccMin--\PubOneNoposAccMax\% without the two fields};
